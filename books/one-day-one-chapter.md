...
- [x] 04/13 - HTTP 완벽 가이드: 01. HTTP 개관
- [x] 04/14 - HTTP 완벽 가이드: 02. URL과 리소스
- [x] 04/15 - HTTP 완벽 가이드: 03. HTTP 메시지
- [x] 04/16 - HTTP 완벽 가이드: 04. 커넥션 관리
- [x] 04/17 - HTTP 완벽 가이드: 05. 웹 서버
- [x] 04/18 - HTTP 완벽 가이드: 06. 프락시
- [x] 04/19 - HTTP 완벽 가이드: 07. 캐시
- [x] 04/20 - HTTP 완벽 가이드: 08. 통합점: 게이트웨이, 터널, 릴레이
- [x] 04/21 - HTTP 완벽 가이드: 09. 웹 로봇
- [x] 04/22 - HTTP 완벽 가이드: 10. HTTP/2.0
- [x] 04/23 - HTTP 완벽 가이드: 11. 클라이언트 식별과 쿠키
- [x] 04/24 - HTTP 완벽 가이드: 12. 기본 인증
- [x] 04/25 - HTTP 완벽 가이드: 13. 다이제스트 인증
- [x] 04/26 - HTTP 완벽 가이드: 14. 보안 HTTP
- [x] 04/27 - HTTP 완벽 가이드: 15. 엔터티와 인코딩
- [ ] 04/28
- [x] 04/29 - HTTP 완벽 가이드: 16. 국제화
- [ ] 04/30
...
- [x] 05/01 - HTTP 완벽 가이드: 17장. 내용 협상과 트랜스코딩
- [x] 05/02 - HTTP 완벽 가이드: 18장. 웹 호스팅
- [x] 05/03 - HTTP 완벽 가이드: 19장. 배포 시스템
- [x] 05/04 - HTTP 완벽 가이드: 20장. 리다이렉션과 부하 균형
- [x] 05/05 - HTTP 완벽 가이드: 21장. 로깅과 사용 추적, 6부 부록

- Kubernetes in action
- [x] 05/06 - Kubernetes in Action: 01. Introducing kubernetes (ing)
- [x] 05/07 
  - kube tutorial; 쿠버네티스 기초 학습: 클러스터 생성하기, 앱 배포하기, 앱 조사하기
- [x] 05/08 - Kubernetes in Action: 01. Introducing kubernetes (ing)
- [x] 05/09 - kube tutorial; 앱 노출하기 (ing)
- [x] 05/10
